...
public class SubCar extends ParkingLot {
    //Lớp Car kế thừa từ ParkingLot
    // Lúc đầu định đặt là SubCar mà quên mất :((
    public SubCar(Customer customer, String name, String liencePlate, double weight)
    {
    ...
    //Hàm tạo ra dữ liệu
    public static SubCar CreateCar(Customer customer, String name, String liencePlate, double weight){
        return new SubCar(customer, name, liencePlate, weight);
    }
