            ...
            for (Contract con : contractList) {
                if (con.getIDContract().equals(txtInfoID.getText())) {
                    ...
                    if (cbGroup.getValue() == CONST.SUBCAR) {
                        SubCar newSubCar = SubCar.CreateCar(newCus, nameCar, lience, 0.0);
                        Contract newContract = new Contract(txtInfoID.getText(), newDateInput, newDateOutput, newSubCar, CONST.SUBCAR);
